  ...
  return (
    <>
      <div className="h-[calc(100vh-80px)] overflow-x-hidden lg:px-12 px-2 bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
        <div className="flex flex-col lg:flex-row gap-8 justify-between pb-6 h-full">
              ...
              <div className="space-y-6 pb-12 text-base">
                ...
                <div className="bg-gradient-to-br from-slate-700/50 to-slate-800/50 p-6 rounded-2xl border border-slate-600/30 backdrop-blur-sm hover:shadow-xl transition-all duration-300">
                  <div className="flex items-center gap-4">
                    <p className="w-36 font-semibold text-blue-400">
                      Project Lead
                    </p>
                ...
                <div className="bg-gradient-to-br from-slate-700/50 to-slate-800/50 p-6 rounded-2xl border border-slate-600/30 backdrop-blur-sm hover:shadow-xl transition-all duration-300">
                  <div className="flex items-start gap-4">
                    <p className="w-36 font-semibold text-purple-400">
                      Members :
                    </p>
                    <div className="flex items-center gap-3 flex-wrap">
                      {project.projectDetails?.team.map((item) => (
                        <div
                          key={item}
                          className="flex items-center gap-2 bg-slate-600/30 px-3 py-2 rounded-xl hover:bg-slate-600/50 transition-colors"
                        >
                ...
                <div className="bg-gradient-to-br from-slate-700/50 to-slate-800/50 p-6 rounded-2xl border border-slate-600/30 backdrop-blur-sm hover:shadow-xl transition-all duration-300">
                  <div className="flex items-center gap-4">
                    <p className="w-36 font-semibold text-emerald-400">
                      Category
                    </p>
                    <p className="text-white font-bold text-lg">
                ...
                <div className="bg-gradient-to-br from-slate-700/50 to-slate-800/50 p-6 rounded-2xl border border-slate-600/30 backdrop-blur-sm hover:shadow-xl transition-all duration-300">
                  <div className="flex items-center gap-4">
                    ...
                    <Badge
                      className="bg-emerald-600/80 hover:bg-emerald-700 text-white px-4 py-2 rounded-full font-semibold backdrop-blur-sm shadow-lg"
                      value="in_progress"
                    >
                      in_progress
                    </Badge>
